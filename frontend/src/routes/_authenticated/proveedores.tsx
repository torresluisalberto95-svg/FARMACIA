            ...
            {items.map(p => (
              <TableRow key={p.id}>
                <TableCell className="font-medium">
                  {p.nombre}
                  <div className="text-xs text-muted-foreground sm:hidden">{p.nit ?? ""} {p.telefono ? `· ${p.telefono}` : ""}</div>
                </TableCell>
                <TableCell className="hidden sm:table-cell">{p.nit ?? "—"}</TableCell>
                <TableCell className="hidden sm:table-cell">{p.telefono ?? "—"}</TableCell>
                <TableCell className="hidden md:table-cell">{p.correo ?? "—"}</TableCell>
