...
ALTER TABLE configuracion ADD COLUMN IF NOT EXISTS email                  TEXT;
ALTER TABLE configuracion ADD COLUMN IF NOT EXISTS reg_invima             TEXT;
ALTER TABLE configuracion ADD COLUMN IF NOT EXISTS qf_responsable         TEXT;
ALTER TABLE configuracion ADD COLUMN IF NOT EXISTS resolucion_dian        TEXT;
ALTER TABLE configuracion ADD COLUMN IF NOT EXISTS habilitacion_pos       TEXT;
ALTER TABLE configuracion ADD COLUMN IF NOT EXISTS persona_natural_nombre  TEXT;
ALTER TABLE configuracion ADD COLUMN IF NOT EXISTS persona_natural_cc      TEXT;
ALTER TABLE configuracion ADD COLUMN IF NOT EXISTS persona_natural_celular TEXT;
ALTER TABLE configuracion ADD COLUMN IF NOT EXISTS persona_natural_dir     TEXT;
